...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 560.0, 676.0, 150.0, 74.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 560.0, 676.0, 315.0, 33.0 ],
					"text" : "// Load the bpatchers/modules from snippets for now\nThis overview is a temp.placeholder"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ -1.0, 8.0, 1327.0, 697.0 ],
					"pic" : "ModuleOverview.png",
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 8.0, 1327.0, 697.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 848.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 744.0, 838.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 744.0, 807.0, 29.5, 22.0 ],
					"text" : "+"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 805.0, 776.0, 32.0, 22.0 ],
					"text" : "* 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 744.0, 772.0, 38.0, 22.0 ],
					"text" : "% 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 850.0, 704.0, 97.0, 22.0 ],
					"text" : "scale 0 660 0 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 738.0, 667.0, 69.0, 22.0 ],
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 738.0, 704.0, 102.0, 22.0 ],
					"text" : "scale 0 1230 0 11"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 1700.0, 526.0, 406.0, 47.0 ],
