        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 884.0, 157.0, 77.0, 22.0 ],
                    "text": "loadmess 40"
                }
            },
            {
            ...
            },
            {
                "box": {
                                        ...
                                        "boxes": [
                                            {
                                                "box": {
                                                    ...
                                                    "numoutlets": 2,
                                                    "outlettype": [ "", "" ],
                                                    "patching_rect": [ 328.0, 142.0, 159.0, 21.0 ],
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "numoutlets": 1,
                                                    "outlettype": [ "" ],
                                                    "patching_rect": [ 351.0, 31.0, 65.0, 22.0 ],
                                                    "text": "r preSetup"
                                                }
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "numoutlets": 1,
                                                    "outlettype": [ "" ],
                                                    "patching_rect": [ 351.0, 69.0, 51.0, 22.0 ],
                                                    "text": "/type $1"
                                                }
                                            },
                                            {
                    ...
                    "patching_rect": [ 933.0, 322.0, 103.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 933.0, 358.0, 81.0, 22.0 ],
                    "text": "s speakerPos"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "text": "spat5.hoa.decoder~ @order 5 @outputs 23 @dimension 3D @mc 1 @initwith \"/method energypreserving, /type inphasemaxre\"",
