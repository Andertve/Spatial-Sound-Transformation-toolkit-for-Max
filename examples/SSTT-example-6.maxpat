        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 652.0, 335.0, 46.0, 24.0 ],
                    "text": "a,b"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 663.0, 170.0, 35.0, 24.0 ],
                    "text": "c"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 301.0, 279.0, 354.0, 96.0 ],
                    "viewvisibility": 1
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 362.0, 112.0, 293.0, 147.0 ],
                    "viewvisibility": 1
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 33.0, 138.0, 320.0, 108.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 33.0, 531.0, 1131.0, 172.0 ],
                    "presentation": 1,
