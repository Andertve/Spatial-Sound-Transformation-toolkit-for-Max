        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 563.0, 333.5, 152.0, 154.0 ],
                    "text": "The result is a diffuse field and we have destroyed the phase and gain of the ambisonic components so its not ambisonic anymore. However that may not be so important either, but if you want to be on the ambisonic domain we can use the ReEncoder! -see example 10"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 323.0, 337.0, 191.0, 80.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 100.0, 118.0, 324.0, 108.0 ],
                    "viewvisibility": 1
                }
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 100.0, 520.0, 1130.0, 170.0 ],
                    "viewvisibility": 1
                }
            }
        ],
