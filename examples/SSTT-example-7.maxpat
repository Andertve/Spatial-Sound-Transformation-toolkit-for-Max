        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 197.0, 617.0, 368.0, 60.0 ],
                    "text": "with mc.dac you can define your channel routing using a list object, In this example the loudspeaker setup in the decoder a bit different ( center is ch.2) so we route accordinly+ the sub is dedicated to output 4"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1012.0, 300.0, 85.0, 22.0 ],
                    "text": "/Sub_ch_sel 4"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 1012.0, 256.0, 58.0, 22.0 ],
                    "text": "loadbang"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 1012.0, 333.0, 231.0, 35.0 ],
                    "text": "spat5.osc.prepend /SSTT-example-7/param"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1012.0, 370.0, 122.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 689.0, 391.0, 152.0, 39.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 496.0, 109.0, 162.0, 221.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "parameter_enable": 0,
                    "patching_rect": [ 35.0, 46.0, 150.0, 30.0 ],
                    "quality": "basic",
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 90.0, 617.0, 75.0, 22.0 ],
                    "text": "1 3 2 5 6 7 8"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 35.0, 649.0, 54.0, 22.0 ],
                    "text": "mc.dac~"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 35.0, 109.0, 328.0, 108.0 ],
                    "viewvisibility": 1
                }
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 35.0, 432.0, 1149.0, 170.0 ],
                    "viewvisibility": 1
                }
            }
        ],
