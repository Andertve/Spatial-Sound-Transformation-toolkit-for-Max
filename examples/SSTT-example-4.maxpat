{
    "patcher": {
        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 170.99999618530273, 239.0, 237.0, 64.0 ],
                    "viewvisibility": 1
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 482.0, 156.0, 276.0, 114.0 ],
                    "text": "// What if we Ringmodulate (RM) the ambisonic signal? So that the spherical harmonics i.e directional components are being RM , the Spatial RM ringmodulates the Spherical compenets either in harmonic ratios or in an fm modulated ratio ( chaotic)\n\nI.e timbre and spatial properties are tied"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 36.0, 100.0, 323.0, 107.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 36.0, 452.0, 1132.0, 173.0 ],
                    "presentation": 1,
        ...
        "parameters": {
            ...
            "obj-24::obj-5": [ "drywet[1]", "drywet", 0 ],
