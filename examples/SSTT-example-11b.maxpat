{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1107.0, 313.0, 150.0, 39.0 ],
                    "text": "Try some RM presets"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1187.0, 363.0, 70.0, 22.0 ],
                    "text": "loadmess 2"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 1135.0, 365.0, 46.0, 18.0 ],
                    "preset_data": [
                        {
                            "number": 1,
                            "data": [ 5, "obj-25", "number", "float", 33.29999923706055 ]
                        },
                        {
                            "number": 2,
                            "data": [ 5, "obj-25", "number", "float", 0.0 ]
                        },
                        {
                            "number": 3,
                            "data": [ 5, "obj-25", "number", "float", 1147.0 ]
                        }
                    ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "float" ],
                    "patching_rect": [ 536.0, 192.0, 149.0, 73.0 ]
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 1135.0, 387.0, 50.0, 22.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1139.0, 414.0, 75.0, 22.0 ],
                    "text": "/RM_freq $1"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 1139.0, 442.0, 118.0, 35.0 ],
                    "text": "spat5.osc.prepend /SSTT-example-11b/"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1139.0, 486.0, 113.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "float" ],
                    "patching_rect": [ 676.0, 365.0, 149.0, 73.0 ]
                }
            },
            {
                "box": {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 467.0, 332.0, 130.0, 22.0 ],
                                    "text": "scale 0. 1000. 0. 0.001"
                                }
                            },
                            {
                                "box": {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "bang" ],
                                    "patching_rect": [ 723.0, 262.0, 76.0, 22.0 ],
                                    "text": "metro 7000"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "multichannelsignal" ],
                                    "patching_rect": [ 697.0, 553.0, 92.0, 35.0 ],
                                    "text": "mc.gen~ tester @chans 36",
                                    "wrapper_uniquekey": "u536007611"
                                }
                            },
                            {
                                "box": {
                    ...
                    "patching_rect": [ 536.0, 123.0, 117.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 730.0, 163.0, 300.0, 154.0 ],
                    "text": "\nThis is a technique you can use for a mc signal to ambisonic as long as your mc no.of channel correponds to the t-format and ambisonic order:\nThe t-format expetcs 4, 12 ,24, 36, 49, 64, 81,100 and 144 for ambisonic order 1 2 3 4 5 6 7 8 9\n\nHere in this example is a synth with mc objects. which adapts to the t-format channels based on the ambisonic order, and with the Spatial RM at the end of the chain"
                }
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 148.0, 76.0, 325.0, 111.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal", "multichannelsignal" ],
                    "patching_rect": [ 176.0, 252.0, 297.0, 95.0 ],
                    "viewvisibility": 1
                }
            },
            {
        ...
        "parameters": {
            ...
            "obj-20::obj-5": [ "live.tab[3]", "live.tab", 0 ],
