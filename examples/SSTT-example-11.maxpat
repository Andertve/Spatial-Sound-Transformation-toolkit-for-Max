        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 59.0, 20.0, 150.0, 47.0 ],
                    "text": "just a placeholder for defining ambisonic order and channels"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 48.0, 73.5, 303.0, 105.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 398.0, 260.0, 304.0, 97.0 ],
                    "viewvisibility": 1
                }
            },
            {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 203.0, 286.0, 143.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "multichannelsignal" ],
                                    "patching_rect": [ 38.0, 645.0, 984.0, 22.0 ],
                                    "text": "mc.pack~ 49",
                                    "varname": "spectr_pack"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "patching_rect": [ 37.0, 587.0, 987.0, 22.0 ],
