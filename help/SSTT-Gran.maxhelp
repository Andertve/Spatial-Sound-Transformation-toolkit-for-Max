        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 20.0, 55.0, 789.0, 33.0 ],
                    "text": "Basically a Spat5-granular + t-design encoder, accepts either an ambisonic input or a mono input (It extracts the W channel from the ambisonic input). The output is a full sphere ambisonic signal where the grains have been mapped around a virtual sphere, "
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 50.0, 314.0, 150.0, 79.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 759.0, 346.0, 58.0, 22.0 ],
                    "text": "loadbang"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 759.0, 376.0, 67.0, 22.0 ],
                    "text": "/drywet 75,"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 759.0, 404.0, 227.0, 22.0 ],
                    "text": "spat5.osc.prepend /SSTT-Gran.maxhelp/"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 759.0, 441.0, 113.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "parameter_enable": 0,
                    "patching_rect": [ 26.0, 111.0, 164.0, 39.0 ],
                    "quality": "basic",
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 20.0, 404.0, 154.0, 65.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 296.0, 284.0, 383.0, 114.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 20.0, 161.0, 329.0, 108.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 20.0, 659.0, 54.0, 22.0 ],
                    "text": "mc.dac~"
                }
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 20.0, 482.0, 1130.0, 168.0 ],
                    "viewvisibility": 1
                }
            }
        ],
