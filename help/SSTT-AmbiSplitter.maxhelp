        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "text": "An Ambisonic signal has horizontal and vertical spherical components. The AmbiSplitter splits the signal into Horizontal and Vertical so you can for examples process them separatly. The Splitter works with the Ambi-Combiner which sums components back into H+V"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 40.0, 545.0, 1134.0, 170.0 ],
                    "presentation": 1,
