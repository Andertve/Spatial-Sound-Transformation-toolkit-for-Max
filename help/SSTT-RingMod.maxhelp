        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 20.0, 55.0, 494.0, 60.0 ],
                    "presentation_linecount": 3,
                    "text": "the Spatial RM ringmodulates the Spherical components in Ambisonic either in harmonic ratios or in an fm modulated ratio (chaotic)\nI.e timbre and spatial properties are tied.\n"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 30.0, 336.0, 237.0, 64.0 ],
                    "viewvisibility": 1
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 30.0, 626.0, 54.0, 22.0 ],
                    "text": "mc.dac~"
                }
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 30.0, 202.0, 306.0, 107.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 30.0, 421.0, 1132.0, 173.0 ],
                    "presentation": 1,
