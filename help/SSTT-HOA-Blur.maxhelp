{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "patching_rect": [ 30.0, 334.0, 191.0, 80.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 217.90625, 802.71484375, 191.0, 80.0 ],
                    "viewvisibility": 1
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "text": "Creates a spatial blur effect in ambisonic, The module is essentially spat5.hoa.blur~ but with automatic scaling of order and channels."
                }
            },
            {
                "box": {
        ...
        "parameters": {
            ...
            "obj-9::obj-23": [ "spat_HOAblur", "blur", 0 ],
            "obj-9::obj-4": [ "ShowCh[6]", "showCh", 0 ],
            "obj-9::obj-79": [ "ShowCh[22]", "showCh", 0 ],
            "parameterbanks": {
                "0": {
                    "index": 0,
                    "name": "",
