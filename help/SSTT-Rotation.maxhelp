{
    "patcher": {
        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 21.0, 57.0, 745.0, 60.0 ],
                    "text": "Ambisonic rotation, Rotate in ambisonics, basically the spat5.hoa.rotate~ with added functionality of automatic scalable order and channels\nYaw= rotation along the Z pole\nPitch = rotation up down\nRoll = rotation along the sides i.e rolling from side to side"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 35.0, 727.0, 54.0, 22.0 ],
                    "text": "mc.dac~"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 35.0, 367.0, 323.0, 101.0 ],
                    "viewvisibility": 1
                }
            },
            {
                "box": {
                    ...
                    "parameter_enable": 0,
                    "patching_rect": [ 35.0, 180.0, 150.0, 30.0 ],
                    "quality": "basic",
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 35.0, 222.0, 304.0, 105.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 35.0, 547.0, 1133.0, 173.0 ],
                    "presentation": 1,
        ...
        "parameters": {
            ...
            "obj-5::obj-38::obj-3": [ "live.tab", "live.tab", 0 ],
